...
#sys.path.append('../wdm_reg_debug')
#sys.path.append('../wdm_reg_log_4_J_D')
sys.path.append('../ada_smooth')
import neuron.layers as nrn_layers
import neuron.utils as nrn_utils
import reg.layers as gaussian_layers
import reg.utils as gaussian_utils
...
# https://github.com/voxelmorph/voxelmorph
def Reg_Net(vol_size, enc_nf, dec_nf, int_steps=7, use_miccai_int=False, indexing='ij', bidir=False, vel_resize=1/2, stage='Training'):
    """
...
class Log_Exp(Layer):
    """
    Keras Layer: Log to exponential
    """
    def __init__(self, **kwargs):
        super(Log_Exp, self).__init__(**kwargs)

    def build(self, input_shape):
        super(Log_Exp, self).build(input_shape)
